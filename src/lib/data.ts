...
export const stack: TrackGroup[] = [
  ...
  },
  {
    ...
    label: "Languages",
    color: "var(--clip-blue)",
    items: ["TypeScript", "JavaScript (ES6+)", "Python", "PHP", "HTML5 / CSS3"],
  },
  {
    n: "03",
    label: "Frameworks",
...
export const projectLog: LogEntry[] = [
  ...
  },
  {
    ...
    stack: ["React", "Three.js", "Supabase", "AWS"],
    status: "Shipped",
    color: "var(--clip-red)",
  ...
  },
  {
    ...
    type: "Industrial site",
    stack: ["WordPress", "PHP", "jQuery", "SwiperJS"],
    status: "Shipped",
    color: "var(--clip-amber)",
  ...
  },
  {
    ...
    status: "Shipped",
    color: "var(--clip-amber)",
    href: "https://mccordcontractors.com",
  },
  {
    year: "2022",
    title: "SilverCare",
  ...
  },
  {
    ...
    status: "Shipped",
    color: "var(--clip-coral)",
    href: "https://edgedentalsolutions.com",
  },
  {
    year: "2021",
    title: "TD Goodwin",
  ...
  },
  {
    ...
    status: "Shipped",
    color: "var(--clip-cyan)",
    href: "https://github.com/merinogeospatial/know-your-vote",
  },
  {
    year: "2018",
    ...
    status: "Shipped",
    color: "var(--clip-cyan)",
    href: "https://github.com/itsrichardhaar/Hidden-Talents",
  },
  {
    year: "2018",
    title: "HiJack",
    ...
    status: "Shipped",
    color: "var(--clip-cyan)",
    href: "https://github.com/itsrichardhaar/HiJack/tree/master/Alice",
  },
  {
    year: "2018",
    title: "Mongo Scraper",
    ...
    status: "Shipped",
    color: "var(--clip-cyan)",
    href: "https://github.com/itsrichardhaar/mongo-scraper",
  },
  {
    year: "2018",
    title: "Bamazon App",
    ...
    status: "Shipped",
    color: "var(--clip-cyan)",
    href: "https://github.com/itsrichardhaar/bamazon-app",
  },
  {
    year: "2018",
    title: "Liri Node App",
    ...
    status: "Shipped",
    color: "var(--clip-cyan)",
    href: "https://github.com/itsrichardhaar/liri-node-app",
  },
  {
    year: "2018",
    title: "Trivia Game",
    ...
    status: "Shipped",
    color: "var(--clip-cyan)",
    href: "https://github.com/itsrichardhaar/Homework-5/",
  },
];
